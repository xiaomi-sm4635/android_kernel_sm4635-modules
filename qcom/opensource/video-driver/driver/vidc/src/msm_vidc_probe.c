...
static inline bool is_video_device(struct device *dev)
{
	return !!(of_device_is_compatible(dev->of_node, "qcom,sm8450-vidc") ||
		...
		of_device_is_compatible(dev->of_node, "qcom,sm4635-vidc") ||
		of_device_is_compatible(dev->of_node, "qcom,sm4635-vidc-v2") ||
...
static const struct of_device_id msm_vidc_dt_match[] = {
	...
	{.compatible = "qcom,sm4635-vidc"},
	{.compatible = "qcom,sm4635-vidc-v2"},
